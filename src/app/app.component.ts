...
export class AppComponent {
  ...
  cat() {
    ...
    if (this.aktiveCategorie == 'Mindset') {
      ...
      this.mainImg = '../assets/img/Mindset.svg'
      this.bgImg = '../assets/img/MindsetNew.png'
    }
    // Blockchain mainImg / bgImg 
    if (this.aktiveCategorie == 'Blockchain') {
      console.log('ist Blockchain')
      this.mainImg = '../assets/img/Blockchain.svg'
      this.bgImg = '../assets/img/BlockchainNew.png'
    }
    // NFT mainImg / bgImg 
    if (this.aktiveCategorie == 'NFT') {
      console.log('ist NFT')
      this.mainImg = '../assets/img/NFT.svg'
      this.bgImg = '../assets/img/NFTNew.png'
    }
